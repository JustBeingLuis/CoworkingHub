...
(2, 'Oficina Privada', 'Oficina cerrada para equipos pequenos'),
...
(2, 'Ana Martinez', 'ana@correo.com', 'pass123', TRUE, 2),
(3, 'Carlos Perez', 'carlos@correo.com', 'pass123', TRUE, 2),
(4, 'Maria Gomez', 'maria@correo.com', 'pass123', TRUE, 2),
(5, 'Andres Lopez', 'andres@correo.com', 'pass123', TRUE, 2),
(6, 'Laura Rodriguez', 'laura@correo.com', 'pass123', TRUE, 2),
(7, 'Pedro Sanchez', 'pedro@correo.com', 'pass123', TRUE, 2),
(8, 'Sofia Herrera', 'sofia@correo.com', 'pass123', TRUE, 2),
(9, 'Daniel Ruiz', 'daniel@correo.com', 'pass123', TRUE, 2),
(10, 'Valentina Castro', 'valentina@correo.com', 'pass123', TRUE, 2),
(11, 'Jorge Ramirez', 'jorge@correo.com', 'pass123', TRUE, 2),
(12, 'Camila Torres', 'camila@correo.com', 'pass123', TRUE, 2),
(13, 'David Morales', 'david@correo.com', 'pass123', TRUE, 2),
(14, 'Paula Jimenez', 'paula@correo.com', 'pass123', TRUE, 2),
(15, 'Miguel Vargas', 'miguel@correo.com', 'pass123', TRUE, 2),
(16, 'Natalia Silva', 'natalia@correo.com', 'pass123', TRUE, 2),
(17, 'Fernando Rios', 'fernando@correo.com', 'pass123', TRUE, 2),
...
SELECT setval(pg_get_serial_sequence('tipos_espacio', 'id'), COALESCE((SELECT MAX(id) FROM tipos_espacio), 1), TRUE);
SELECT setval(pg_get_serial_sequence('espacios', 'id'), COALESCE((SELECT MAX(id) FROM espacios), 1), TRUE);
SELECT setval(pg_get_serial_sequence('estados_reserva', 'id'), COALESCE((SELECT MAX(id) FROM estados_reserva), 1), TRUE);
